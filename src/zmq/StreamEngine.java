...
public class StreamEngine implements IEngine, IPollEvents {
	...
	public StreamEngine(SocketChannel fd_, final Options options_,
		...
		try {
			Constructor<? extends DecoderBase> dcon = options_.decoder
					.getConstructor(int.class, long.class);
			Constructor<? extends EncoderBase> econ = options_.encoder
					.getConstructor(int.class);
			decoder = dcon.newInstance(Config.in_batch_size.getValue(),
					options_.maxmsgsize);
